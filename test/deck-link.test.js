...
const REAL = "check this https://link.clashroyale.com/en?clashroyale://copyDeck?deck=26000007;28000015;26000059;26000012;28000001;26000037;27000000;26000106&slots=0;0;0;0;0;0;0;0&tt=159000000&id=20JJJ2CCRU any good?";
...
test("a real link yields eight cards, the tower troop and the sharer; anything less is not a deck", () => {
  ...
  assert.deepEqual(parseDeckLink("clashroyale://copyDeck?deck=26000007;28000015;26000059;26000012;28000001;26000037;27000000;26000106").cardIds.length, 8);
  assert.equal(parseDeckLink("https://link.clashroyale.com/deck/en?deck=26000007;28000015;26000059"), null, "a partial deck is not a deck");
...
test("the tool resolves names through cards_catalog and says what a link cannot know", async () => {
  ...
  const tool = deckLinkTool({
    resolve: async (name, args) => {
      ...
      return { ok: true, body: { cards: [{ id: 26000007, name: "Giant", rarity: "rare", elixir: 5 }, { id: 159000000, name: "Tower Princess", rarity: "common" }] } };
    },
  });
